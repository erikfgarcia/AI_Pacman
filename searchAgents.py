...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        # happens when it visits all corners 
    ...
    def getSuccessors(self, state):
	    ...
	    #"*** YOUR CODE HERE ***"
            ...
            if not hitsWall:
                if (nextx, nexty) not in foundCorners and (nextx, nexty) in self.corners:
...
def cornersHeuristic(state, problem):
    ...
    while unexploredCorners:   
        ...
        for corner in unexploredCorners:
            distance = min( util.manhattanDistance(currentNode, corner), curMin )
            if curMin != distance: 
                curMin = distance
                curCor = corner
